object FrmSincronizar: TFrmSincronizar
  ...
  object qryProdutos: TFDQuery
    ...
    SQL.Strings = (
      ...
      'pro.empresa=:id'
      'and '
      'pro.ativo='#39'S'#39' and pro.RESTAUTANTE = '#39'S'#39)
    Left = 360
    Top = 144
    ParamData = <
      item
  ...
  object qryEmpresa: TFDQuery
    ...
    SQL.Strings = (
        ...
        'select codigo, Fantasia, Razao, Endereco, Numero, Bairro, Fone, ' +
        'Cidade, Uf, Cep, Cnpj, Ie, complemento, CWEB from empresa'
      'where codigo =:id')
    Left = 38
    Top = 79
    ParamData = <
    ...
    object qryEmpresaCWEB: TIntegerField
      FieldName = 'CWEB'
      Origin = 'CWEB'
    end
  end
